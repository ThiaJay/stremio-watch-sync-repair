...
export function defaultProfile(id='main'){return {
 ...
 trakt:{mode:'stremio-native',stremioWriteEnabled:false,syncMarkUnwatched:true,confirmUnwatchedCycles:2,conflictPolicy:'manual',maxChanges:20,intervalMinutes:15},
